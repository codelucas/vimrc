...
hi Directory term=bold ctermfg=Red guifg=Red                                                                                      
hi LineNr term=underline ctermfg=Yellow guifg=Yellow                                                                              
hi MoreMsg term=bold ctermfg=LightGreen gui=bold guifg=SeaGreen                                                                   
hi NonText term=bold ctermfg=LightBlue gui=bold guifg=LightBlue guibg=grey90                                                      
hi Question term=standout ctermfg=LightGreen gui=bold guifg=Green                                                                 
hi Search term=reverse ctermbg=Yellow ctermfg=White guibg=Yellow guifg=Black                                                      
...
hi Number ctermfg=Red ctermbg=White guifg=Red gui=bold 

" Groups for syntax highlighting
hi Constant term=underline ctermfg=Magenta guifg=#a07070 guibg=grey80                                                             
hi Special term=bold ctermfg=DarkCyan guifg=DarkOrange guibg=grey80
if &t_Co > 8
